...
public:
    // SIMULATOR::prob_actions = {0.649, 0.570, 0.649, 0.733, 0.2, 0.849, 0.657}; //Probabilities of actions depending of counterexamples of axioms - ADD 0.2 AT 5th POSITION FOR EXIT
...
protected:
    ...
    std::vector<double> prob_rs = {0.649, 0.570, 0.649, 0.733, 0.2, 0.657, 0.849}; //probability of actions derived from 15 PART axioms
    // std::vector<double> prob_rs = {680/5832.0 * 3538/9902.0, 1083/5832.0 * 3538/9902.0, 911/5832.0 * 3538/9902.0, 148/5832.0 * 3538/9902.0, 2307/9902.0, 677/9902.0 * 3538/9902.0, 1087/9902.0}; // action probabilities for rules generated with 11 PART
    int Size, NumRocks;
    COORD StartPos;
