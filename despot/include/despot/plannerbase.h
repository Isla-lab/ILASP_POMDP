		...
		{ { E_HELP, 0, "", "help", option::Arg::None,
				...
				{ E_NUMBER, 0, "", "number", option::Arg::Required,
						"  \t--number <arg>  \tNumber of elements of a problem (problem "
								"specific)." },
				{ E_prob_food, 0, "", "prob_food", option::Arg::Optional,
						"  \t--prob_food <arg>  \tprob_food of elements of a problem (problem "
								"specific)." },
				{ E_prob_ghosts, 0, "", "prob_ghosts", option::Arg::Optional,
						"  \t--prob_ghosts <arg>  \tprob_ghosts of elements of a problem (problem "
								"specific)." },
